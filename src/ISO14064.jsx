...
const services = [
  { icon: 'fa-clipboard-check', title: 'ISO 14064-1 Implementation', description: 'Development and implementation of organization-level GHG inventories in accordance with ISO 14064-1 requirements, covering all emission sources and sinks.' },
  { icon: 'fa-project-diagram', title: 'ISO 14064-2 Project Certification', description: 'Quantification and certification of GHG emission reduction projects, enabling you to demonstrate measurable environmental improvements.' },
  { icon: 'fa-search', title: 'ISO 14064-3 Verification', description: 'Independent third-party verification of GHG inventories and project claims, providing credibility and assurance to your environmental reporting.' },
  { icon: 'fa-database', title: 'GHG Inventory Development', description: 'Comprehensive assessment and documentation of all GHG emission sources and sinks across your organization\'s operations and value chain.' },
  { icon: 'fa-chart-bar', title: 'Data Collection & Analysis', description: 'Systematic collection, validation, and analysis of emission data using robust methodologies to ensure accuracy and completeness of your GHG inventory.' },
  { icon: 'fa-file-alt', title: 'Reporting & Documentation', description: 'Preparation of ISO 14064-compliant GHG reports and documentation that meet regulatory requirements and stakeholder expectations.' },
  { icon: 'fa-chalkboard-teacher', title: 'Training & Capacity Building', description: 'Training programs for your team on ISO 14064 requirements, GHG accounting methodologies, and implementation best practices.' },
  { icon: 'fa-headset', title: 'Ongoing Support', description: 'Continuous support for maintaining and improving your GHG management system, including surveillance audits and updated reporting guidance.' }
]

const benefits = [
  { icon: 'fa-gavel', title: 'Legal Compliance', desc: 'Achieve and demonstrate legal compliance in areas of the world where verification is a legal requirement.' },
  { icon: 'fa-exchange-alt', title: 'Emission Trading', desc: 'Allow for the company to participate in emission trading schemes.' },
  { icon: 'fa-shoe-prints', title: 'Carbon Footprint', desc: 'Identify operational carbon footprint and opportunities for reduction.' },
  { icon: 'fa-bolt', title: 'Energy Optimisation', desc: 'Identify opportunities for energy consumption and optimisation of energy efficiency.' },
  { icon: 'fa-users', title: 'Stakeholder Disclosure', desc: 'Present credible disclosure to stakeholders and investors.' },
  { icon: 'fa-user-shield', title: 'Personnel Awareness', desc: 'Increase of energy and environmental awareness among personnel.' },
  { icon: 'fa-handshake', title: 'Management Commitment', desc: 'Demonstrate management commitment to environmental responsibility.' },
  { icon: 'fa-leaf', title: 'Corporate Image', desc: 'Improvement of corporate image through verified environmental performance.' }
]
    ...
    <div>
      ...
      <section className="relative min-h-[55vh] flex items-center justify-center overflow-hidden bg-[#030a16]">
        <div className="absolute inset-0 z-0">
          <img src="/s2.png" className="w-full h-full object-cover opacity-30" alt="ISO 14064 GHG Management" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center py-20">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-eurogold-400/30 bg-eurogold-400/5 mb-6">
            ...
            <span className="heading-font text-[10px] text-eurogold-400 tracking-[0.3em] uppercase font-bold">Greenhouse Gas quantification, monitoring, reporting & verification</span>
          </div>
          <h1 className="heading-font text-4xl sm:text-6xl md:text-7xl font-bold text-white mb-3 tracking-tight" style={{ textShadow: '0 0 30px rgba(212,168,67,0.3)' }}>
            ISO 14064 — GHG Management
          </h1>
          <p className="text-white/50 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Credible GHG accounting and verification at organizational and project levels.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            <div className="lg:col-span-3 space-y-6">
              <div>
                ...
                <h2 className="heading-font text-3xl md:text-4xl font-bold text-slate-900 tracking-tight leading-tight">
                  Carbon Foot Print Assessment — <span className="text-euro-600">ISO 14064</span>
                </h2>
              </div>
              <p className="text-slate-500 text-[15px] leading-relaxed">
                Carbon Foot Print assessment is now a concern for all stakeholders involved in the issue of climate change. It is fundamental for managing greenhouse gases. Green House Gases are mainly CO2, methane, nitrous oxide and ozone.
              </p>
              <p className="text-slate-500 text-[15px] leading-relaxed">
                It is required by companies that are involved in GHG emissions trading according 2003/87/EC or in national emission reduction projects. But more and more other companies who have a socially responsible goal are seeking verification. Third-party verification is necessary to establish the credibility of the reported reductions.
              </p>
              <div className="p-6 rounded-2xl border border-euro-100 bg-euro-50/40">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h4 className="heading-font text-[11px] text-euro-600 font-bold uppercase tracking-widest">Applicable Sectors</h4>
                </div>
                <p className="text-slate-500 text-sm leading-relaxed">
                  Carbon foot print assessment refers mostly to cement factories, pulp and paper producing installations, ceramic product factories, lime production installations, mineral oil refineries and also activities that include combustion emissions or airline companies, but the list of related sectors is expanding. However, ISO 14064, a voluntary standard may be applied for all companies.
                </p>
              </div>
            </div>
            <div className="lg:col-span-2 relative rounded-2xl overflow-hidden shadow-xl border border-slate-100 h-[320px] md:h-[400px] group">
              <img src="/s2.png" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="ISO 14064 Carbon Footprint Assessment" />
      ...
      {/* Benefits of Verification - Soft BG */}
      <section className="py-14 lg:py-18 bg-[#f8fafc]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-10">
            <h4 className="heading-font text-[11px] text-euro-600 tracking-[0.5em] uppercase mb-2 font-bold">Verification Benefits</h4>
            <h2 className="heading-font text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">
              Benefits of Carbon Footprint <span className="text-euro-600">Verification</span>
            </h2>
          </div>
      ...
      <section className="py-14 lg:py-18 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="heading-font text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">
              ISO 14064 <span className="text-euro-600">Services</span>
            </h2>
          </div>
        ...
        <div className="relative z-10 py-14 lg:py-18">
          <div className="container mx-auto px-6">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-10">
                <h4 className="heading-font text-[11px] text-eurogold-400 tracking-[0.5em] uppercase mb-2 font-bold">Trusted Verification Partner</h4>
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="p-8 rounded-2xl border border-white/5 bg-white/2">
                  ...
                  <p className="text-white/50 text-sm leading-relaxed mb-4">
                    Eurocert has earned recognition by conducting Verification of Greenhouse Gas Emissions data for well-known companies for many years.
                  </p>
        ...
        <div className="relative z-10 py-14 lg:py-18">
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-2xl mx-auto p-10 sm:p-12 rounded-2xl border border-white/5 bg-white/2">
              ...
              <p className="text-white/45 mb-6 max-w-lg mx-auto text-sm leading-relaxed">Our GHG management experts are ready to guide your organization through ISO 14064 certification.</p>
