...
const benefits = [
  { icon: 'fa-lock', title: 'ISO 28000 certification', desc: 'Globally recognized certification for supply chain security management systems.' },
  { icon: 'fa-shipping-fast', title: 'Supply chain security management', desc: 'Comprehensive framework to secure your supply chain operations.' },
  { icon: 'fa-shield-alt', title: 'Risk assessment & mitigation', desc: 'Identify and address security risks across the supply chain.' },
  { icon: 'fa-cogs', title: 'Security system implementation', desc: 'Implement robust security controls and procedures.' },
  { icon: 'fa-search', title: 'Threat & vulnerability assessment', desc: 'Systematic evaluation of threats and vulnerabilities.' },
  { icon: 'fa-sync-alt', title: 'Business continuity planning', desc: 'Ensure resilience and continuity of supply chain operations.' },
  { icon: 'fa-truck', title: 'Customs facilitation', desc: 'Streamline customs processes and compliance requirements.' },
  { icon: 'fa-globe-europe', title: 'International trade security', desc: 'Meet international security standards for global trade.' }
]
...
export default function ISO28000Social() {
      ...
      <section className="relative min-h-[55vh] flex items-center justify-center overflow-hidden bg-[#030a16]">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center py-20">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-eurogold-400/30 bg-eurogold-400/5 mb-6">
            ...
            <span className="heading-font text-[10px] text-eurogold-400 tracking-[0.3em] uppercase font-bold">Security Management Systems for the Supply Chain</span>
          </div>
          ...
          <p className="text-white/50 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Security management systems to ensure security in the supply chain.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="p-6 rounded-2xl border border-euro-100 bg-euro-50/40">
                ...
                <p className="text-slate-500 text-sm leading-relaxed">
                  ISO 28000 addresses threat assessment, risk management, security planning, security implementation, and supply chain resilience — providing a comprehensive framework for securing supply chain operations.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="heading-font text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">
              Benefits of ISO 28000 <span className="text-euro-600">Certification</span>
            </h2>
          </div>
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="p-8 rounded-2xl border border-white/5 bg-white/2">
                  ...
                  <p className="text-white/50 text-sm leading-relaxed mb-4">
                    Eurocert has earned recognition by conducting supply chain security audits and ISO 28000 certifications for well-known companies for many years.
                  </p>
