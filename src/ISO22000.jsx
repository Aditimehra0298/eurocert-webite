...
const services = [
  { icon: 'fa-utensils', title: 'Food Safety Management System', description: 'Complete implementation of ISO 22000-compliant food safety management systems tailored to your organization\'s processes and food chain position.' },
  { icon: 'fa-clipboard-check', title: 'ISO 22000 Certification Audits', description: 'Thorough certification audits conducted by experienced food safety auditors to verify compliance with all ISO 22000 requirements.' },
  { icon: 'fa-chalkboard-teacher', title: 'Training & Consultancy', description: 'Expert training programs and consultancy services to build internal competence in food safety management and ISO 22000 implementation.' },
  { icon: 'fa-chart-line', title: 'Continuous Improvement Support', description: 'Structured approach to continual improvement of your food safety management system with regular reviews and performance monitoring.' },
  { icon: 'fa-search', title: 'Hazard Analysis & PRPs', description: 'Comprehensive hazard analysis and prerequisite program development to identify, evaluate, and control food safety hazards systematically.' },
  { icon: 'fa-headset', title: 'Ongoing Compliance Support', description: 'Continuous monitoring and support to maintain your ISO 22000 certification and adapt to evolving food safety standards and regulations.' }
]

const benefits = [
  { icon: 'fa-check-circle', title: 'Food Safety', desc: 'Ensure food safety throughout the entire food chain with a systematic management approach.' },
  { icon: 'fa-shield-alt', title: 'Risk Management', desc: 'Manage food safety risks effectively through structured hazard analysis and control measures.' },
  { icon: 'fa-balance-scale', title: 'Regulatory Compliance', desc: 'Meet local and international food safety regulatory requirements with an internationally recognized standard.' },
  { icon: 'fa-users', title: 'Customer Confidence', desc: 'Build customer confidence in your products with ISO 22000 certified food safety management.' },
  { icon: 'fa-globe-europe', title: 'Market Access', desc: 'Meet requirements of food safety-conscious buyers and access global markets with recognized certification.' }
]

const relatedServices = [
  { title: 'FSSC 22000', subtitle: 'Food Safety Certification', image: '/F4.png', link: '/food/fssc-22000' },
  { title: 'HACCP', subtitle: 'Hazard Analysis', image: '/F3.png', link: '/food/haccp' },
  { title: 'IFS', subtitle: 'Food Safety Standards', image: '/F1.png', link: '/food/ifs' }
]
    ...
    <div>
      ...
      <section className="relative min-h-[55vh] flex items-center justify-center overflow-hidden bg-[#030a16]">
        <div className="absolute inset-0 z-0">
          <img src="/F5.png" className="w-full h-full object-cover opacity-30" alt="ISO 22000 Food Safety Management" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center py-20">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-eurogold-400/30 bg-eurogold-400/5 mb-6">
            ...
            <span className="heading-font text-[10px] text-eurogold-400 tracking-[0.3em] uppercase font-bold">International standard for food safety management systems</span>
          </div>
          ...
          <p className="text-white/50 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Framework for managing food safety risks across the food chain.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            <div className="lg:col-span-3 space-y-6">
              <div>
                ...
                <h2 className="heading-font text-3xl md:text-4xl font-bold text-slate-900 tracking-tight leading-tight">
                  ISO 22000 — <span className="text-euro-600">Food Safety Management</span>
                </h2>
              </div>
              <p className="text-slate-500 text-[15px] leading-relaxed">We provide comprehensive ISO 22000 certification and compliance services to help your organization meet food safety regulatory requirements and industry standards.</p>
              <div className="p-6 rounded-2xl border border-euro-100 bg-euro-50/40">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h4 className="heading-font text-[11px] text-euro-600 font-bold uppercase tracking-widest">What is ISO 22000?</h4>
                </div>
                <p className="text-slate-500 text-sm leading-relaxed">ISO 22000 is an international standard that specifies requirements for a food safety management system. It helps organizations in the food chain ensure food safety by providing a framework for managing food safety risks.</p>
              </div>
            </div>
            <div className="lg:col-span-2 relative rounded-2xl overflow-hidden shadow-xl border border-slate-100 h-[320px] md:h-[400px] group">
              <img src="/F5.png" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="ISO 22000 Food Safety Management" />
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="heading-font text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">
              ISO 22000 <span className="text-euro-600">Services</span>
            </h2>
          </div>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-5 gap-10 max-w-6xl mx-auto">
              ...
              <div className="lg:col-span-2 p-8 rounded-2xl border border-white/5 bg-white/2 flex flex-col justify-center">
                ...
                <p className="text-white/45 text-sm leading-relaxed mb-6">Our experienced auditors understand food safety management requirements and can guide you through the certification process.</p>
        ...
        <div className="relative z-10 py-14 lg:py-18">
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-2xl mx-auto p-10 sm:p-12 rounded-2xl border border-white/5 bg-white/2">
              ...
              <p className="text-white/45 mb-6 max-w-lg mx-auto text-sm leading-relaxed">Our food safety experts are ready to guide your organization through ISO 22000 certification.</p>
