...
const services = [
  { icon: 'fa-hands-helping', title: 'ISO 26000 Guidance Implementation', description: 'Expert support in implementing ISO 26000 guidance across your organization, integrating social responsibility into core business strategies, policies, and operations.' },
  { icon: 'fa-chart-bar', title: 'Social Responsibility Assessment', description: 'Comprehensive assessment of your organization\'s social responsibility performance across all seven core subjects of ISO 26000 with actionable recommendations.' },
  { icon: 'fa-seedling', title: 'Sustainable Development Practices', description: 'Development and integration of sustainable development practices aligned with ISO 26000 principles, helping your organization contribute to environmental and social well-being.' },
  { icon: 'fa-users', title: 'Stakeholder Engagement Support', description: 'Structured stakeholder engagement frameworks to identify, prioritize, and communicate with key stakeholders, building trust and transparency in your social responsibility efforts.' },
  { icon: 'fa-chalkboard-teacher', title: 'Training & Consultancy', description: 'Comprehensive training programs on ISO 26000 principles, core subjects, and implementation approaches for management teams and employees across your organization.' },
  { icon: 'fa-file-alt', title: 'Reporting & Communication Support', description: 'Assistance in developing social responsibility reports and communication strategies to transparently share your organization\'s social responsibility performance with stakeholders.' }
]

const benefits = [
  { icon: 'fa-seedling', title: 'Sustainable Development', desc: 'Contribute meaningfully to sustainable development through structured social responsibility practices.' },
  { icon: 'fa-handshake', title: 'Stakeholder Trust', desc: 'Build lasting trust with stakeholders through transparent and responsible business conduct.' },
  { icon: 'fa-star', title: 'Brand Reputation', desc: 'Enhance your brand reputation as a socially responsible organization in the marketplace.' },
  { icon: 'fa-shield-alt', title: 'Risk Management', desc: 'Effectively manage social responsibility risks and reduce exposure to reputational issues.' },
  { icon: 'fa-trophy', title: 'Competitive Advantage', desc: 'Stand out as a socially responsible organization and attract responsible partners and customers.' }
]

const relatedServices = [
  { title: 'SA 8000', subtitle: 'Social accountability', image: '/b1.png', link: '/post/sa-8000-certification' },
  { title: 'ISO 14001', subtitle: 'Environmental Management', image: '/m3.png', link: '/management-system/iso-14001' },
  { title: 'ISO 37001', subtitle: 'Anti-Bribery', image: '/b12.png', link: '/management-system/iso-37001' }
]
      ...
      <section className="relative min-h-[55vh] flex items-center justify-center overflow-hidden bg-[#030a16]">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center py-20">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-eurogold-400/30 bg-eurogold-400/5 mb-6">
            ...
            <span className="heading-font text-[10px] text-eurogold-400 tracking-[0.3em] uppercase font-bold">Guidance on social responsibility and sustainable development</span>
          </div>
          ...
          <p className="text-white/50 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Guidance for organizations to contribute to sustainable development.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            <div className="lg:col-span-3 space-y-6">
              ...
              <p className="text-slate-500 text-[15px] leading-relaxed">We provide comprehensive ISO 26000 implementation support to help your organization integrate social responsibility into core business strategies.</p>
              <div className="p-6 rounded-2xl border border-euro-100 bg-euro-50/40">
                ...
                <p className="text-slate-500 text-sm leading-relaxed">ISO 26000 is an international standard providing guidance on social responsibility. It helps organizations contribute to sustainable development by encouraging them to go beyond legal compliance and recognize that adherence to law is a fundamental duty of any organization and an essential part of their social responsibility.</p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="heading-font text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">
              ISO 26000 <span className="text-euro-600">Services</span>
            </h2>
          </div>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-5 gap-10 max-w-6xl mx-auto">
              ...
              <div className="lg:col-span-2 p-8 rounded-2xl border border-white/5 bg-white/2 flex flex-col justify-center">
                ...
                <p className="text-white/45 text-sm leading-relaxed mb-6">Our experienced professionals understand social responsibility requirements and can guide your implementation.</p>
        ...
        <div className="relative z-10 py-14 lg:py-18">
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-2xl mx-auto p-10 sm:p-12 rounded-2xl border border-white/5 bg-white/2">
              ...
              <p className="text-white/45 mb-6 max-w-lg mx-auto text-sm leading-relaxed">Our social responsibility experts are ready to guide your organization through ISO 26000 implementation.</p>
