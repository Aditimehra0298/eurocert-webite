...
const services = [
  { icon: 'fa-shield-alt', title: 'ISO 27017 Certification & Compliance', description: 'Full scope verification and certification for Cloud Security guidelines and controls under ISO 27017.' },
  { icon: 'fa-clipboard-check', title: 'Comprehensive Audit & Assessment', description: 'Thorough on-site and documentation audits to evaluate your cloud security controls and management system.' },
  { icon: 'fa-chalkboard-teacher', title: 'Training & Consultancy', description: 'Expert coaching and training for your teams on ISO 27017 implementation and cloud security best practices.' },
  { icon: 'fa-headset', title: 'Ongoing Compliance Support', description: 'Continuous monitoring and support to maintain your ISO 27017 certification and cloud security standards.' },
  { icon: 'fa-file-alt', title: 'Documentation & Reporting', description: 'Professional cloud security documentation, risk assessments, and compliance reporting assistance.' },
  { icon: 'fa-sync-alt', title: 'Remediation Support', description: 'Fixing non-conformities and gaps identified during the cloud security assessment process.' }
]

const benefits = [
  { icon: 'fa-check-circle', title: 'Regulatory Compliance', desc: 'Meet all regulatory requirements for cloud security controls and guidelines.' },
  { icon: 'fa-globe-europe', title: 'Market Access', desc: 'Access markets requiring ISO 27017 certification worldwide.' },
  { icon: 'fa-award', title: 'Quality Assurance', desc: 'Demonstrate commitment to securing cloud-based information systems.' },
  { icon: 'fa-trophy', title: 'Competitive Advantage', desc: 'Stand out in your industry with internationally recognized cloud security certification.' },
  { icon: 'fa-shield-alt', title: 'Risk Management', desc: 'Reduce cloud security risks and protect sensitive data in cloud environments.' }
]
    ...
    <div>
      ...
      <section className="relative min-h-[55vh] flex items-center justify-center overflow-hidden bg-[#030a16]">
        <div className="absolute inset-0 z-0">
          <img src="/m14.png" className="w-full h-full object-cover opacity-30" alt="ISO 27017 Cloud Security" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center py-20">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-eurogold-400/30 bg-eurogold-400/5 mb-6">
            ...
            <span className="heading-font text-[10px] text-eurogold-400 tracking-[0.3em] uppercase font-bold">Cloud security guidelines</span>
          </div>
          ...
          <p className="text-white/50 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Guidelines for information security controls applicable to cloud services.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            <div className="lg:col-span-3 space-y-6">
              <div>
                ...
                <h2 className="heading-font text-3xl md:text-4xl font-bold text-slate-900 tracking-tight leading-tight">
                  ISO 27017 — <span className="text-euro-600">Cloud Security</span>
                </h2>
              </div>
              <p className="text-slate-500 text-[15px] leading-relaxed">We provide comprehensive ISO 27017 certification and compliance services to help your organization meet regulatory requirements and industry best practices.</p>
              <div className="p-6 rounded-2xl border border-euro-100 bg-euro-50/40">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h4 className="heading-font text-[11px] text-euro-600 font-bold uppercase tracking-widest">What is ISO 27017?</h4>
                </div>
                <p className="text-slate-500 text-sm leading-relaxed">ISO 27017 is an important standard/certification that helps organizations demonstrate compliance with regulatory requirements and industry best practices. It provides guidelines for information security controls applicable to the provision and use of cloud services, securing cloud-based information systems and protecting sensitive data.</p>
              </div>
            </div>
            <div className="lg:col-span-2 relative rounded-2xl overflow-hidden shadow-xl border border-slate-100 h-[320px] md:h-[400px] group">
              <img src="/m14.png" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="ISO 27017 Cloud Security" />
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="heading-font text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">
              ISO 27017 <span className="text-euro-600">Services</span>
            </h2>
          </div>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-5 gap-10 max-w-6xl mx-auto">
              ...
              <div className="lg:col-span-2 p-8 rounded-2xl border border-white/5 bg-white/2 flex flex-col justify-center">
                ...
                <p className="text-white/45 text-sm leading-relaxed mb-6">Our experienced auditors understand cloud security requirements and can guide you through the certification process.</p>
        ...
        <div className="relative z-10 py-14 lg:py-18">
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-2xl mx-auto p-10 sm:p-12 rounded-2xl border border-white/5 bg-white/2">
              ...
              <p className="text-white/45 mb-6 max-w-lg mx-auto text-sm leading-relaxed">Our cloud security experts are ready to guide your organization through ISO 27017 certification.</p>
