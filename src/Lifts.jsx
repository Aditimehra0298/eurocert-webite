...
const services = [
  { icon: 'fa-shield-alt', title: 'Certification & Compliance', description: 'Full scope verification for Lifts Directive (2014/33/EU) requirements and safety compliance.' },
  { icon: 'fa-clipboard-check', title: 'Audit & Assessment', description: 'Comprehensive safety assessment and technical file evaluation for all lift types.' },
  { icon: 'fa-chalkboard-teacher', title: 'Training & Consultancy', description: 'Expert coaching on lifts safety requirements and technical documentation standards.' },
  { icon: 'fa-headset', title: 'Ongoing Support', description: 'Continuous compliance monitoring and updates for lift modifications and upgrades.' },
  { icon: 'fa-file-alt', title: 'Documentation & Reporting', description: 'Technical file preparation, Declaration of Conformity, and safety documentation review.' },
  { icon: 'fa-sync-alt', title: 'Remediation Support', description: 'Addressing non-conformities and implementing corrective actions for lift safety.' }
]

const benefits = [
  { title: 'Regulatory Compliance', desc: 'Meet all Lifts Directive requirements for EU market access.' },
  ...
  { title: 'Competitive Advantage', desc: 'Stand out as a certified and compliant lift manufacturer.' },
    ...
    <div ref={pageRef}>
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden bg-[#030a16]">
        <div className="absolute inset-0 z-0">
          <img src="/lifts-directive.png" className="w-full h-full object-cover opacity-25" alt="Lifts" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center py-24">
          <h4 data-reveal="reveal-up" className="heading-font text-[11px] text-eurogold-400 tracking-[0.5em] uppercase mb-6 font-bold">Lifts Directive (2014/33/EU)</h4>
          <h1 data-reveal="reveal-up" data-reveal-delay="150" className="heading-font text-5xl sm:text-7xl md:text-8xl font-bold text-white mb-4 tracking-tight" style={{ textShadow: '0 0 20px rgba(212,168,67,0.4)' }}>CE Certification for</h1>
          <h3 data-reveal="reveal-up" data-reveal-delay="250" className="heading-font text-white/80 text-base md:text-xl uppercase tracking-[0.3em] mb-4">Lifts</h3>
          ...
          <p data-reveal="reveal-up" data-reveal-delay="450" className="text-white/60 text-sm md:text-lg max-w-2xl mx-auto leading-relaxed">Lifts Directive compliance for EU market access</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-8">
            <div data-reveal="reveal-left">
              ...
              <h2 className="heading-font text-4xl md:text-5xl font-bold text-slate-900 tracking-tight leading-tight">CE Certification for<br /><span className="text-euro-600">Lifts</span></h2>
            </div>
            <p data-reveal="reveal-left" data-reveal-delay="150" className="text-slate-500 text-lg leading-relaxed">We provide comprehensive Lifts certification and compliance services to help your organization meet regulatory requirements and industry standards.</p>
            <div data-reveal="reveal-left" data-reveal-delay="250" className="p-8 rounded-3xl border border-euro-200 bg-euro-50/50">
              <h4 className="heading-font text-[11px] text-euro-600 font-bold uppercase tracking-widest mb-4">What is Lifts Directive?</h4>
              <p className="text-slate-500 text-sm leading-relaxed">The Lifts Directive (2014/33/EU) ensures that lifts and lifting equipment placed on the EU market meet essential health and safety requirements. It covers passenger lifts, goods lifts, service lifts, lifting platforms, and safety components for lifts.</p>
            </div>
          </div>
          <div data-reveal="reveal-right" data-reveal-delay="200" className="relative rounded-3xl overflow-hidden shadow-[0_32px_80px_-15px_rgba(0,0,0,0.1)] border border-slate-100 h-[350px] sm:h-[450px] md:h-[550px] group">
            <img src="/lifts-directive.png" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" alt="Lifts Certification" />
        ...
        <div className="relative z-10 py-16 lg:py-20">
          <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div data-reveal="reveal-right" data-reveal-delay="200" className="p-10 sm:p-12 rounded-[3rem] border border-white/5 bg-white/[0.02] flex flex-col justify-center">
              ...
              <p className="text-white/50 text-lg leading-relaxed mb-10">Our experienced auditors understand Lifts Directive requirements and can guide you through the certification process.</p>
        ...
        <div className="relative z-10 py-16 lg:py-20">
          <div className="container mx-auto px-6 text-center">
            <div data-reveal="reveal-scale" className="max-w-3xl mx-auto p-12 sm:p-16 rounded-[3rem] border border-white/5 bg-white/[0.02]">
              <h4 className="heading-font text-[11px] text-eurogold-400 tracking-[0.5em] uppercase mb-4 font-bold">Initiate Lifts Compliance</h4>
              <h2 className="heading-font text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight mb-6">Quick Inquiry</h2>
              <p className="text-white/50 mb-8 max-w-xl mx-auto leading-relaxed">Our lifts certification experts are ready to guide your organization through Lifts Directive compliance and CE marking certification.</p>
