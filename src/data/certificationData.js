export const certificationData = [
  {
    ...
    details: [
      ...
      'Fire safety and resistance testing'
    ]
  },
  {
    id: 'lifts',
    ...
    details: [
      ...
      'Installation conformity assessment',
  ...
  },
  {
    ...
    details: [
      ...
      'SVHC identification and reporting',
  ...
  },
  {
    ...
    details: [
      ...
      'Protective systems approval',
      'Zone classification support',
      'Ignition source documentation',
  ...
  },
  {
    ...
    details: [
      ...
      'Periodic inspection services',
      'Cylinder and vessel approval',
      'Transport documentation',
      'ADR/RID compliance support'
    ]
  },
  {
    id: 'railway',
    ...
    details: [
      ...
      'Subsystem conformity assessment',
      'Technical documentation',
  ...
  },
  {
    ...
    details: [
      ...
      'Ship safety equipment assessment',
      'Firefighting equipment approval',
...
export const specializedStandards = [
  {
    id: 'en-15085',
    title: 'EN 15085 Railway Welding',
    description: 'Fusion welding certification for railway vehicles and components.',
    icon: 'fa-train'
  },
  {
    id: 'en-1090',
    title: 'EN 1090 Structural',
    description: 'CE marking for structural steel and aluminum fabrications.',
    icon: 'fa-building'
  },
  {
    id: 'iso-3834',
  ...
  {
    id: 'en-1997',
    title: 'EN 1997 Geotechnical',
    description: 'Geotechnical design and ground investigation standards.',
    icon: 'fa-layer-group'
  },
  {
    id: 'en-1090-exe',
    title: 'EN 1090 Execution',
    description: 'Execution classes for steel and aluminum structures.',
