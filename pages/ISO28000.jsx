...
const services = [
  {
    ...
    description: 'Complete ISO 28000 certification services covering all requirements for establishing, implementing, and maintaining a security management system for your supply chain operations.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Comprehensive supply chain security management solutions including threat assessment, vulnerability analysis, and implementation of robust security controls across your operations.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Systematic identification, analysis, and evaluation of security risks across your supply chain, with tailored mitigation strategies to reduce exposure to threats and vulnerabilities.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert guidance on designing and implementing a security management system aligned with ISO 28000 requirements, including policies, procedures, and operational controls.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Comprehensive training programs on ISO 28000 requirements, supply chain security best practices, risk assessment methodologies, and security management for your teams.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Continuous support to maintain ISO 28000 compliance including surveillance audit preparation, management review facilitation, and ongoing security improvement guidance.'
  }
]

const benefits = [
  { title: 'Enhanced Security', desc: 'Improve the security of your supply chain operations with a structured, internationally recognized management system.' },
  { title: 'Risk Management', desc: 'Systematically identify and mitigate security risks across your entire supply chain from end to end.' },
  { title: 'Regulatory Compliance', desc: 'Meet security requirements and regulations applicable to your supply chain operations and trade activities.' },
  { title: 'Customer Confidence', desc: 'Demonstrate your commitment to supply chain security, building trust with customers and business partners.' },
  { title: 'Competitive Advantage', desc: 'Stand out as a secure and reliable business partner in the global supply chain marketplace.' }
]
...
export default function ISO28000() {
  const [formData, setFormData] = useState({
    ...
    email: '',
    mobile: '',
    service: 'ISO 28000 Certification',
    message: ''
  })
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'ISO 28000 Certification', message: '' })
  }
    ...
    <div className="font-sans antialiased selection:bg-accent selection:text-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        <div className="absolute inset-0 z-0">
          <img src="/b10.png" className="w-full h-full object-cover opacity-20 scale-105" alt="ISO 28000 Supply Chain Security" />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Security management systems for supply chain operations</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            ISO 28000 <br/><span className="text-accent">Supply Chain Security</span>
          </h1>
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-gray-800 leading-tight uppercase tracking-tighter">
                ISO 28000 <br/><span className="text-accent">Certification</span>
              </h2>
            </div>
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              ISO 28000 is an international standard for security management systems in the supply chain. It helps organizations establish, implement, maintain, and improve security management systems to protect supply chain operations.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is ISO 28000?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                ISO 28000 specifies requirements for a security management system, including those aspects critical to security assurance of the supply chain. It helps organizations manage security risks in their supply chains and protect their operations from security threats.
              </p>
            </div>
          </div>
          <div className="relative rounded-[2rem] overflow-hidden shadow-lg border border-gray-200 h-[400px] sm:h-[500px]">
            <img src="/b10.png" className="w-full h-full object-cover opacity-80" alt="ISO 28000 Supply Chain Security" />
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 uppercase tracking-widest leading-none">
              Our ISO 28000 <span className="text-accent">Services</span>
            </h2>
      ...
      <section className="py-16 md:py-24 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          <div className="space-y-12">
            <h3 className="text-3xl font-display font-black text-gray-800 uppercase tracking-widest border-l-4 border-accent pl-6">Benefits of ISO 28000</h3>
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand ISO 28000 requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Start your ISO 28000 certification journey. Our supply chain security experts are ready to assist you.
                </p>
                <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <select name="service" value={formData.service} onChange={handleChange} className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-600 text-sm focus:outline-none focus:border-accent/50 focus:bg-gray-100 transition appearance-none">
                    <option value="ISO 28000 Certification">ISO 28000 Certification</option>
                    <option value="C-TPAT">C-TPAT Validation</option>
