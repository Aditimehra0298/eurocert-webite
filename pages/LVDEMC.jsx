...
const services = [
  {
    ...
    title: 'LVD/EMC Certification & Compliance',
    description: 'Complete certification services for electrical equipment under Low Voltage Directive 2014/35/EU and EMC Directive 2014/30/EU.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Comprehensive electrical safety testing and electromagnetic compatibility assessment for your products.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert guidance on LVD/EMC requirements, harmonized standards, and compliance strategies.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Continuous surveillance and support to maintain LVD/EMC certification compliance.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Technical file preparation, EC declarations of conformity, and test reports for LVD/EMC compliance.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Corrective actions for non-conformities in electrical safety and EMC performance.'
  }
]

const benefits = [
  { title: 'Regulatory Compliance', desc: 'Meet all EU Low Voltage Directive and EMC Directive requirements.' },
  { title: 'Market Access', desc: 'Access to European markets with CE marked electrical and electronic equipment.' },
  { title: 'Quality Assurance', desc: 'Demonstrate commitment to electrical safety and electromagnetic compatibility.' },
  { title: 'Competitive Advantage', desc: 'Stand out as a certified manufacturer of compliant electrical products.' },
  { title: 'Risk Management', desc: 'Reduce liability risks through proper safety testing and documentation.' }
]
...
const relatedServices = [
  ...
  { title: 'RoHS', subtitle: 'Compliance', image: '/rohs-certification.png', link: '/ce-certification' }
]
...
export default function LVDEMC() {
  const [formData, setFormData] = useState({
    name: '',
    email: '',
    mobile: '',
    service: 'LVD/EMC Certification',
    message: ''
  })
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'LVD/EMC Certification', message: '' })
  }
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Low Voltage and EMC Directive Compliance</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            CE Marking <br/><span className="text-accent">LVD/EMC</span>
          </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              We provide comprehensive LVD/EMC certification and compliance services to help your organization meet regulatory requirements and industry standards.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is LVD/EMC?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                The Low Voltage Directive (LVD) 2014/35/EU and Electromagnetic Compatibility (EMC) Directive 2014/30/EU are essential for electrical and electronic equipment sold in the EU. LVD ensures electrical safety for equipment operating between 50-1000V AC or 75-1500V DC, while EMC ensures equipment doesn't cause electromagnetic interference and is immune to external interference.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 relative z-10 bg-navy-light/20 border-y border-gray-100">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            ...
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Our LVD/EMC Services</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand LVD/EMC requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Initiate your LVD/EMC compliance transmission. Our industrial nodes are active and ready.
                </p>
            ...
            <div className="lg:w-7/12 bg-white p-10 sm:p-16 relative">
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    <option value="LVD/EMC Certification">LVD/EMC Certification</option>
