...
const services = [
  {
    ...
    title: 'Lifts Certification & Compliance',
    description: 'Complete certification services for lifts and lifting equipment under the Lifts Directive 2014/33/EU.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Comprehensive safety evaluation of passenger lifts, goods lifts, and safety components.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert guidance on Lifts Directive requirements, safety standards, and best practices.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Continuous surveillance and periodic inspections to maintain lift certification compliance.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Technical file preparation, EC declarations, and compliance documentation for lifts.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Corrective actions for non-conformities in lift safety systems and components.'
  }
]

const benefits = [
  { title: 'Regulatory Compliance', desc: 'Meet all EU Lifts Directive 2014/33/EU requirements for lift installations.' },
  { title: 'Market Access', desc: 'Access to European markets with CE marked lifts and safety components.' },
  { title: 'Quality Assurance', desc: 'Demonstrate commitment to lift safety and quality standards.' },
  { title: 'Competitive Advantage', desc: 'Stand out as a certified lift manufacturer or installer.' },
  { title: 'Risk Management', desc: 'Reduce liability risks through proper safety documentation and testing.' }
]
...
export default function Lifts() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'Lifts Certification', message: '' })
  }
    ...
    <div className="font-sans antialiased selection:bg-accent selection:text-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        <div className="absolute inset-0 z-0">
          <img 
            src="/lifts-directive.png" 
            className="w-full h-full object-cover opacity-20 scale-105" 
            alt="Lifts Certification"
          />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Lifts Directive 2014/33/EU Compliance</span>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              We provide comprehensive Lifts certification and compliance services to help your organization meet regulatory requirements and industry standards.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is Lifts Certification?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                The Lifts Directive 2014/33/EU requires that lifts and safety components for lifts placed on the EU market must be CE marked. This certification covers passenger lifts, goods lifts, service lifts, lifting platforms, and safety components. It ensures that lifts meet essential health and safety requirements for users and maintenance personnel.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 relative z-10 bg-navy-light/20 border-y border-gray-100">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            ...
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Our Lifts Services</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand Lifts requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Initiate your Lifts compliance transmission. Our industrial nodes are active and ready.
                </p>
            ...
            <div className="lg:w-7/12 bg-white p-10 sm:p-16 relative">
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    <option value="Lifts Certification">Lifts Certification</option>
