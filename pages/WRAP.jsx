...
const services = [
  {
    ...
    title: 'WRAP Certification Audits',
    description: 'Complete WRAP certification audit services covering all 12 WRAP principles, ensuring your facility meets the requirements for responsible and ethical manufacturing practices.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Compliance with WRAP Principles',
    description: 'Thorough verification of compliance across all 12 WRAP principles including labor rights, workplace safety, environmental responsibility, customs compliance, and security.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Labor & Human Rights Verification',
    description: 'In-depth assessment of labor practices including forced labor prevention, child labor prohibition, fair wages, working hours, non-discrimination, and freedom of association.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Assessment of environmental management practices including waste management, chemical handling, emissions control, water usage, and compliance with environmental regulations.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Pre-Certification Assessments',
    description: 'Comprehensive gap analysis and readiness assessment before the official WRAP certification audit, identifying areas for improvement and ensuring you are fully prepared.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert guidance on developing and implementing corrective action plans to address non-conformances, with follow-up verification to ensure sustained compliance.'
  }
]

const benefits = [
  { title: 'Meet Buyer Requirements', desc: 'Many leading brands and retailers require WRAP certification from their manufacturing partners.' },
  { title: 'Demonstrate Ethical Practices', desc: 'Show commitment to responsible manufacturing through independent, globally recognized certification.' },
  { title: 'Improve Working Conditions', desc: 'Enhance workplace safety, worker satisfaction, and overall facility conditions for employees.' },
  { title: 'Access to Global Markets', desc: 'Meet requirements of international buyers and open doors to new business opportunities worldwide.' },
  { title: 'Competitive Advantage', desc: 'Stand out as an ethical manufacturer committed to safe, lawful, humane, and responsible production.' }
]

const relatedServices = [
  { title: 'SA 8000', subtitle: 'Social accountability certification', image: '/b1.png', link: '/social/sa-8000' },
  { title: 'SEDEX / SMETA', subtitle: 'Ethical trade audits', image: '/b2.png', link: '/social/sedex-smeta' },
...
export default function WRAP() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'WRAP Certification', message: '' })
  }
    ...
    <div className="font-sans antialiased selection:bg-accent selection:text-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        <div className="absolute inset-0 z-0">
          <img src="/b4.png" className="w-full h-full object-cover opacity-20 scale-105" alt="WRAP Certification" />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Independent social compliance certification for ethical manufacturing</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            WRAP <br/><span className="text-accent">Certification</span>
          </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              WRAP is an independent, objective, non-profit team of global social compliance experts dedicated to promoting safe, lawful, humane, and ethical manufacturing around the world.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is WRAP?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                WRAP is the world's largest independent facility-based social compliance certification program for the sewn products industry. WRAP certification demonstrates that a facility operates in compliance with local laws and internationally accepted standards for ethical workplace practices.
              </p>
            </div>
          </div>
          <div className="relative rounded-[2rem] overflow-hidden shadow-lg border border-gray-200 h-[400px] sm:h-[500px]">
            <img src="/b4.png" className="w-full h-full object-cover" alt="WRAP Certification" />
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-display font-black text-gray-800 uppercase tracking-widest leading-none">
              12 WRAP <span className="text-accent">Principles</span>
            </h2>
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">The foundation of responsible manufacturing</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {wrapPrinciples.map((principle, index) => (
              <div key={index} className="glass-panel p-5 rounded-2xl flex items-start gap-4 group hover:border-accent/40 transition-all duration-300">
                <span className="text-accent font-display font-black text-lg leading-none mt-0.5">{String(index + 1).padStart(2, '0')}</span>
                <p className="text-sm text-gray-600 font-sans leading-relaxed">{principle}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Services Grid */}
      <section className="py-16 md:py-24 relative z-10 bg-navy-light/20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 uppercase tracking-widest leading-none">
              Our WRAP <span className="text-accent">Services</span>
            </h2>
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Comprehensive Social Compliance Solutions</p>
          </div>
      ...
      <section className="relative z-10">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="relative rounded-[2rem] overflow-hidden shadow-lg border border-gray-200">
            <img src="/b4.png" className="w-full h-auto object-cover" alt="WRAP Certification Process" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          <div className="space-y-12">
            <h3 className="text-3xl font-display font-black text-gray-800 uppercase tracking-widest border-l-4 border-accent pl-6">Benefits of WRAP Certification</h3>
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our WRAP-certified auditors understand the certification process and can guide you through achieving and maintaining WRAP certification. We work with you to ensure compliance with all WRAP principles.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Start your WRAP certification journey. Our social compliance experts are ready to assist you.
                </p>
                <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <select name="service" value={formData.service} onChange={handleChange} className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-600 text-sm focus:outline-none focus:border-accent/50 focus:bg-gray-100 transition appearance-none">
                    <option value="WRAP Certification">WRAP Certification</option>
