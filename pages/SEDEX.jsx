...
const services = [
  {
    ...
    title: 'SMETA 2-Pillar Audits',
    description: 'Comprehensive 2-pillar audits focusing on Labor Standards and Health & Safety, meeting the requirements of major global retailers and brands for ethical supply chain practices.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'SMETA 4-Pillar Audits',
    description: 'Full-scope 4-pillar audits covering Labor Standards, Health & Safety, Business Ethics, and Environment — providing complete ethical trade assurance across all key areas.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'SEDEX Platform Registration Support',
    description: 'Complete assistance with SEDEX platform registration, profile setup, data management, and ensuring your organization is properly represented on the global ethical trade platform.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Comprehensive Ethical Trade Assessments',
    description: 'In-depth assessments covering all aspects of ethical trade including labor rights, working conditions, fair wages, worker welfare, and responsible business practices.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert guidance on developing corrective action plans, addressing non-conformances, and conducting follow-up audits to verify implementation and sustained improvement.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Training on SEDEX Requirements',
    description: 'Comprehensive training programs for your team on SEDEX platform usage, SMETA audit preparation, ethical trade requirements, and continuous compliance best practices.'
  }
]

const auditSteps = [
  { step: '01', title: 'Pre-Audit Preparation', desc: 'We help you prepare documentation and understand requirements' },
  { step: '02', title: 'On-Site Audit', desc: 'Comprehensive assessment of your facility and practices' },
  { step: '03', title: 'Documentation Review', desc: 'Review of policies, procedures, and records' },
  { step: '04', title: 'Worker Interviews', desc: 'Confidential interviews with workers to understand conditions' },
  { step: '05', title: 'Management Interviews', desc: 'Discussions with management about systems and practices' },
  { step: '06', title: 'Audit Report', desc: 'Detailed report with findings and recommendations' },
  { step: '07', title: 'Remediation Support', desc: 'Guidance on addressing non-conformances' },
  { step: '08', title: 'Report Upload', desc: 'Upload audit report to SEDEX platform' }
]

const benefits = [
  { title: 'Meet Buyer Requirements', desc: 'Many global retailers and brands require SEDEX membership and SMETA audits from their suppliers.' },
  { title: 'Reduce Audit Fatigue', desc: 'Share audit data with multiple buyers through one platform, eliminating the need for duplicate audits.' },
  { title: 'Improve Supply Chain Transparency', desc: 'Demonstrate ethical practices to stakeholders and build trust through transparent reporting.' },
  { title: 'Access to Global Markets', desc: 'Meet requirements of major international buyers and open doors to new business opportunities.' },
  { title: 'Risk Management', desc: 'Identify and address ethical trade risks in your supply chain before they become issues.' },
  { title: 'Continuous Improvement', desc: 'Use audit findings to continuously improve working conditions and business practices.' }
]

const relatedServices = [
  { title: 'SA 8000', subtitle: 'Social accountability certification', image: '/b1.png', link: '/social/sa-8000' },
  { title: 'SLCP', subtitle: 'Social & Labor Convergence Project', image: '/b6.png', link: '/social/slcp' },
  { title: 'Code of Conduct Audits', subtitle: 'Brand and retailer specific compliance', image: '/b3.png', link: '/social/code-of-conduct' }
]
...
export default function SEDEX() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'SEDEX/SMETA Audits', message: '' })
  }
    ...
    <div className="font-sans antialiased selection:bg-accent selection:text-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        <div className="absolute inset-0 z-0">
          <img src="/b2.png" className="w-full h-full object-cover opacity-20 scale-105" alt="SEDEX SMETA Audits" />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Ethical trade audits and SEDEX platform compliance</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            SEDEX / SMETA <br/><span className="text-accent">Audits</span>
          </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            <div className="space-y-4">
              <span className="text-accent font-tech font-bold uppercase tracking-[0.4em] text-xs">Audit Overview</span>
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              We help you demonstrate ethical business practices through SEDEX (Supplier Ethical Data Exchange) compliance and SMETA (Sedex Members Ethical Trade Audit) audits. Our audits check for labor standards, health and safety, business ethics, and environmental compliance.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is SEDEX/SMETA?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                SEDEX is a not-for-profit membership organization dedicated to driving improvements in responsible and ethical business practices in global supply chains. SMETA (Sedex Members Ethical Trade Audit) is the most widely used social audit methodology in the world.
              </p>
            </div>
            {/* SMETA Audit Types */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="glass-panel p-6 rounded-2xl border border-accent/20">
                <h5 className="text-accent font-display font-bold uppercase text-sm mb-2">SMETA 2-Pillar</h5>
                <p className="text-xs text-gray-500 leading-relaxed">Focus on Labor Standards and Health & Safety</p>
              </div>
              <div className="glass-panel p-6 rounded-2xl border border-accent/20">
                <h5 className="text-accent font-display font-bold uppercase text-sm mb-2">SMETA 4-Pillar</h5>
                <p className="text-xs text-gray-500 leading-relaxed">Labor Standards, Health & Safety, Business Ethics, and Environment</p>
              </div>
            </div>
          </div>
          <div className="relative rounded-[2rem] overflow-hidden shadow-lg border border-gray-200 h-[400px] sm:h-[500px]">
            <img src="/b2.png" className="w-full h-full object-cover opacity-80" alt="SEDEX SMETA Audits" />
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 uppercase tracking-widest leading-none">
              Our SEDEX/SMETA <span className="text-accent">Services</span>
            </h2>
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Comprehensive Ethical Trade Audit Solutions</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-display font-black text-gray-800 uppercase tracking-widest leading-none">
              SMETA Audit <span className="text-accent">Process</span>
            </h2>
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Our structured approach to ethical trade auditing</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {auditSteps.map((item, index) => (
              <div key={index} className="glass-panel p-6 rounded-2xl group hover:border-accent/50 transition-all duration-300 relative overflow-hidden">
                <span className="text-6xl font-display font-black text-accent/10 absolute -top-2 -right-2 group-hover:text-accent/20 transition">{item.step}</span>
                <div className="relative z-10">
                  <span className="text-accent font-tech font-bold text-xs uppercase tracking-widest">Step {item.step}</span>
                  <h4 className="text-gray-800 font-display font-bold uppercase text-sm mt-2 mb-2">{item.title}</h4>
      ...
      <section className="py-16 md:py-24 relative z-10 bg-navy-light/20 border-y border-gray-100">
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          <div className="space-y-12">
            <h3 className="text-3xl font-display font-black text-gray-800 uppercase tracking-widest border-l-4 border-accent pl-6">Benefits of SEDEX/SMETA</h3>
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors are SMETA-approved and understand the complexities of ethical trade compliance. We work with you to ensure successful audits and help you maintain compliance with SEDEX requirements.
            </p>
            <div className="space-y-4">
              ...
              <div className="bg-primary/20 p-6 rounded-2xl border border-gray-100">
                ...
                <span className="text-[10px] font-bold text-gray-800 uppercase tracking-[0.3em]">Audit Success Rate</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Start your SEDEX/SMETA audit journey. Our ethical trade audit experts are ready to assist you.
                </p>
                <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <select name="service" value={formData.service} onChange={handleChange} className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-600 text-sm focus:outline-none focus:border-accent/50 focus:bg-gray-100 transition appearance-none">
                    <option value="SEDEX/SMETA Audits">SEDEX / SMETA Audits</option>
                    <option value="SMETA 2-Pillar">SMETA 2-Pillar Audit</option>
                    <option value="SMETA 4-Pillar">SMETA 4-Pillar Audit</option>
                    <option value="SA 8000">SA 8000 Certification</option>
                    <option value="SLCP">SLCP Assessment</option>
