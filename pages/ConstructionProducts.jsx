...
const services = [
  {
    ...
    description: 'Full scope verification for Construction Products Regulation (CPR) requirements.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Comprehensive on-site and technical file assessments to ensure structural integrity.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert coaching for your manufacturing teams on CPR-specific technical documentation.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Dedicated monitoring and compliance updates for recurring product production cycles.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'High-precision technical reporting and Declaration of Performance (DoP) assistance.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Fixing technical non-conformities discovered during the structural assessment phase.'
  }
]

const benefits = [
  { title: 'Regulatory Compliance', desc: 'Seamlessly meet all Construction Products Regulation requirements.' },
  { title: 'Market Access', desc: 'Unlock unrestricted access to European construction markets.' },
  { title: 'Quality Assurance', desc: 'Demonstrate an unwavering commitment to structural safety and quality.' },
  { title: 'Competitive Advantage', desc: 'Stand out as a verified tier-one supplier in the building sector.' },
  { title: 'Risk Management', desc: 'Significantly reduce compliance risks and legal liability.' }
]
...
export default function ConstructionProducts() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'Construction Products', message: '' })
  }
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Sector Directive Node: CPR-305</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            Construction <br/><span className="text-accent">Products</span>
          </h1>
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-gray-800 leading-tight uppercase tracking-tighter">
                CE Certification for <br/><span className="text-accent">Construction Products</span>
              </h2>
            </div>
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              We provide comprehensive Construction Products certification and compliance services to help your organization meet regulatory requirements and industry standards.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is Construction Products?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                Construction Products is an important standard/certification that helps organizations demonstrate compliance with regulatory requirements and industry best practices. The CPR ensures that reliable information about construction products is available to professionals, public authorities, and consumers.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 relative z-10 bg-navy-light/20 border-y border-gray-100">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            ...
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Our Construction Products Services</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand Construction Products requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Initiate your Construction Products compliance transmission. Our industrial nodes are active and ready.
                </p>
