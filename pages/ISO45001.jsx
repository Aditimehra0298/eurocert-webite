...
const services = [
  {
    ...
    title: 'ISO 45001 Certification & Compliance',
    description: 'Full scope verification and certification for Occupational Health & Safety Management System requirements.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Thorough on-site and documentation audits to evaluate your occupational health and safety management system.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert coaching and training for your teams on ISO 45001 implementation and workplace safety best practices.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Continuous monitoring and support to maintain your ISO 45001 certification and safety standards.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Professional OH&S documentation, risk assessments, and management review reporting assistance.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Fixing non-conformities and gaps identified during the health and safety management assessment process.'
  }
]

const benefits = [
  { title: 'Regulatory Compliance', desc: 'Meet all regulatory requirements for occupational health and safety management.' },
  { title: 'Market Access', desc: 'Access markets requiring ISO 45001 certification worldwide.' },
  { title: 'Quality Assurance', desc: 'Demonstrate commitment to worker safety and well-being.' },
  { title: 'Competitive Advantage', desc: 'Stand out in your industry with internationally recognized OH&S certification.' },
  { title: 'Risk Management', desc: 'Reduce workplace incidents, compliance risks, and associated costs.' }
]
...
const relatedServices = [
  ...
  { title: 'ISO 27001', subtitle: 'Information Security', image: '/m5.png', link: '/management-system' }
]
...
export default function ISO45001() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'ISO 45001', message: '' })
  }
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Occupational health and safety management</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            ISO 45001 <br/><span className="text-accent">Health & Safety Management</span>
          </h1>
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-gray-800 leading-tight uppercase tracking-tighter">
                ISO 45001 - <br/><span className="text-accent">Occupational Health & Safety</span>
              </h2>
            </div>
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              We provide comprehensive ISO 45001 certification and compliance services to help your organization meet regulatory requirements and industry standards.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is ISO 45001?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                ISO 45001 is an important standard/certification that helps organizations demonstrate compliance with regulatory requirements and industry best practices. It provides a framework for managing occupational health and safety risks, preventing work-related injury and ill health, and providing safe and healthy workplaces.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 uppercase tracking-widest leading-none">
              Our ISO 45001 <span className="text-accent">Services</span>
            </h2>
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Comprehensive Health & Safety Solutions</p>
          </div>
      ...
      <section className="py-16 md:py-24 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="space-y-12">
            <h3 className="text-3xl font-display font-black text-gray-800 uppercase tracking-widest border-l-4 border-accent pl-6">Benefits of ISO 45001</h3>
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand ISO 45001 requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Initiate your ISO 45001 certification journey. Our health & safety experts are ready to assist you.
                </p>
