...
const services = [
  {
    ...
    title: 'REACH Certification & Compliance',
    description: 'Complete REACH compliance assessment and certification services for chemical substances and products.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Comprehensive evaluation of chemical substances, supply chain verification, and restricted substance testing.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert guidance on REACH regulations, SVHC substances, and chemical management best practices.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Continuous monitoring of REACH updates, candidate list changes, and regulatory developments.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Safety Data Sheets (SDS), chemical registration dossiers, and REACH compliance documentation.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Corrective actions for REACH non-conformities and substance substitution strategies.'
  }
]
...
export default function REACHCompliance() {
  const [formData, setFormData] = useState({
    name: '',
    email: '',
    mobile: '',
    service: 'REACH Compliance',
    message: ''
  })
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'REACH Compliance', message: '' })
  }
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Registration, Evaluation, Authorisation of Chemicals</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            REACH <br/><span className="text-accent">Compliance</span>
          </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative rounded-[2rem] overflow-hidden shadow-lg border border-gray-200 h-[400px] sm:h-[500px]">
            <img 
              ...
              alt="REACH Compliance Certification"
            />
      ...
      <section className="py-16 md:py-24 relative z-10 bg-navy-light/20 border-y border-gray-100">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            ...
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Our REACH Services</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand REACH requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Initiate your REACH compliance transmission. Our industrial nodes are active and ready.
                </p>
