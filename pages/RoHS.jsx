...
const services = [
  {
    ...
    title: 'RoHS Certification & Compliance',
    description: 'Complete certification services for electrical and electronic equipment under the RoHS Directive 2011/65/EU.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Comprehensive RoHS compliance testing, material analysis, and restricted substance verification.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert guidance on RoHS requirements, restricted substances, and compliance strategies.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Continuous monitoring of RoHS updates and supply chain compliance verification.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Technical documentation, declarations of conformity, and RoHS compliance certificates.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Corrective actions for non-conformities and substance substitution recommendations.'
  }
]

const benefits = [
  { title: 'Regulatory Compliance', desc: 'Meet all EU RoHS Directive 2011/65/EU requirements for electrical equipment.' },
  { title: 'Market Access', desc: 'Access to European markets with RoHS-compliant electrical and electronic products.' },
  { title: 'Quality Assurance', desc: 'Demonstrate commitment to environmental protection and hazardous substance control.' },
  { title: 'Competitive Advantage', desc: 'Stand out as a certified manufacturer of RoHS-compliant products.' },
  { title: 'Risk Management', desc: 'Reduce liability risks through proper testing and compliance documentation.' }
]
...
export default function RoHS() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'RoHS Certification', message: '' })
  }
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Restriction of Hazardous Substances</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            RoHS <br/><span className="text-accent">Certification</span>
          </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              We provide comprehensive RoHS certification and compliance services to help your organization meet regulatory requirements and industry standards.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is RoHS?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                The RoHS Directive (Restriction of Hazardous Substances) 2011/65/EU restricts the use of certain hazardous substances in electrical and electronic equipment. It limits lead, mercury, cadmium, hexavalent chromium, polybrominated biphenyls (PBB), polybrominated diphenyl ethers (PBDE), and four phthalates (DEHP, BBP, DBP, DIBP) to protect human health and the environment.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 relative z-10 bg-navy-light/20 border-y border-gray-100">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            ...
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Our RoHS Services</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand RoHS requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Initiate your RoHS compliance transmission. Our industrial nodes are active and ready.
                </p>
