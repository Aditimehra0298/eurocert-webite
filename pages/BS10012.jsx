...
const services = [
  {
    ...
    title: 'BS 10012 Certification & Compliance',
    description: 'Full scope verification and certification for Personal Information Management System requirements under BS 10012.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Thorough on-site and documentation audits to evaluate your personal information management system effectiveness.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert coaching and training for your teams on BS 10012 implementation and data protection best practices.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Continuous monitoring and support to maintain your BS 10012 certification and data protection standards.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Professional data protection documentation, privacy impact assessments, and compliance reporting assistance.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Fixing non-conformities and gaps identified during the data protection management assessment process.'
  }
]

const benefits = [
  { title: 'Regulatory Compliance', desc: 'Meet all regulatory requirements for personal information management and data protection.' },
  { title: 'Market Access', desc: 'Access markets requiring BS 10012 certification worldwide.' },
  { title: 'Quality Assurance', desc: 'Demonstrate commitment to protecting personal data and privacy.' },
  { title: 'Competitive Advantage', desc: 'Stand out in your industry with recognized data protection certification.' },
  { title: 'Risk Management', desc: 'Reduce data breach risks and ensure compliance with global privacy regulations.' }
]
...
export default function BS10012() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'BS 10012', message: '' })
  }
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Personal information management</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            BS 10012 <br/><span className="text-accent">Data Protection</span>
          </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              We provide comprehensive BS 10012 certification and compliance services to help your organization meet regulatory requirements and industry standards.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is BS 10012?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                BS 10012 is an important standard/certification that helps organizations demonstrate compliance with regulatory requirements and industry best practices. It provides a framework for a personal information management system to comply with global data protection regulations and privacy management requirements.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 uppercase tracking-widest leading-none">
              Our BS 10012 <span className="text-accent">Services</span>
            </h2>
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Comprehensive Data Protection Solutions</p>
          </div>
      ...
      <section className="py-16 md:py-24 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="space-y-12">
            <h3 className="text-3xl font-display font-black text-gray-800 uppercase tracking-widest border-l-4 border-accent pl-6">Benefits of BS 10012</h3>
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand BS 10012 requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Initiate your BS 10012 certification journey. Our data protection experts are ready to assist you.
                </p>
            ...
            <div className="lg:w-7/12 bg-white p-10 sm:p-16 relative">
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    <option value="BS 10012">BS 10012 - Data Protection</option>
