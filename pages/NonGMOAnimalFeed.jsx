...
const services = [
  {
    ...
    title: 'Non-GMO Sourcing Verification',
    description: 'Comprehensive verification that all feed ingredients are sourced from non-GMO origins with full documentation and traceability.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Complete traceability assessment for feed materials from raw material sourcing through manufacturing and distribution.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Segregation & Identity Preservation',
    description: 'Evaluation of segregation systems and identity preservation protocols ensuring non-GMO integrity throughout the production process.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'GMO Testing & Analysis',
    description: 'Regular testing protocols for GMO presence in feed ingredients using accredited laboratory methods and sampling procedures.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Training & Personnel Programs',
    description: 'Comprehensive training programs for personnel handling non-GMO feed to ensure awareness and compliance at every level.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Establishment and verification of internal audit and monitoring procedures to maintain ongoing non-GMO compliance.'
  }
]

const benefits = [
  { title: 'Supply Chain Integrity', desc: 'Verified non-GMO status for animal products throughout the entire feed supply chain.' },
  { title: 'Market Premium', desc: 'Higher value for non-GMO fed animal products including meat, dairy, and eggs.' },
  { title: 'Consumer Confidence', desc: 'Transparent labeling for end consumers with certified non-GMO assurance.' },
  { title: 'EU Compliance', desc: 'Meet European regulations on non-GMO labeling and feed chain requirements.' },
  { title: 'Retailer Requirements', desc: 'Satisfy growing retailer demands for non-GMO sourcing and verified supply chains.' }
]

const relatedServices = [
  { title: 'Non-GMO Products', subtitle: 'Product Certification', image: '/F16.png', link: '/food' },
  { title: 'EU Organic', subtitle: 'Organic Certification', image: '/F10.png', link: '/food/eu-organic' },
  { title: 'GLOBALGAP', subtitle: 'Good Agricultural Practices', image: '/F2.png', link: '/food' }
]
...
export default function NonGMOAnimalFeed() {
  const [formData, setFormData] = useState({
    name: '',
    email: '',
    mobile: '',
    service: 'Non-GMO Animal Feed',
    message: ''
  })
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'Non-GMO Animal Feed', message: '' })
  }
    ...
    <div className="font-sans antialiased selection:bg-accent selection:text-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        <div className="absolute inset-0 z-0">
          <img src="/F17.png" className="w-full h-full object-cover opacity-20 scale-105" alt="Non-GMO Animal Feed Certification" />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Ensuring animal feed products are free from GMOs</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            Non-GMO Animal <br/><span className="text-accent">Feed Certification</span>
          </h1>
          <p className="text-sm md:text-xl text-gray-500 font-tech font-bold uppercase tracking-[0.3em]">
            GMO-Free Feed Chain Verification
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              Non-GMO Animal Feed certification verifies that animal feed products and their raw materials are produced without genetically modified organisms. This certification is essential for the supply chain of non-GMO animal products including meat, dairy, and eggs.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is Non-GMO Animal Feed Certification?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                This certification ensures that feed materials used in animal nutrition are sourced and processed without genetically modified ingredients. It covers the entire supply chain from raw material sourcing through manufacturing and distribution, ensuring that non-GMO integrity is maintained at every stage.
              </p>
            </div>
          </div>
          <div className="relative rounded-[2rem] overflow-hidden shadow-lg border border-gray-200 h-[400px] sm:h-[500px]">
            <img src="/F17.png" className="w-full h-full object-cover opacity-80" alt="Non-GMO Animal Feed" />
      ...
      <section className="py-16 md:py-24 relative z-10 bg-navy-light/20 border-y border-gray-100">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            ...
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Comprehensive Non-GMO Feed Chain Verification</p>
          </div>
      ...
      <section className="py-16 md:py-24 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          <div className="space-y-12">
            <h3 className="text-3xl font-display font-black text-gray-800 uppercase tracking-widest border-l-4 border-accent pl-6">Benefits of Certification</h3>
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Eurocert Asia has experienced auditors specializing in feed chain certification. We provide thorough verification of your non-GMO animal feed systems and help you achieve internationally recognized certification.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Start your Non-GMO Animal Feed certification journey. Our feed chain certification experts are ready to assist you.
                </p>
                <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <select name="service" value={formData.service} onChange={handleChange} className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-600 text-sm focus:outline-none focus:border-accent/50 focus:bg-gray-100 transition appearance-none">
                    <option value="Non-GMO Animal Feed">Non-GMO Animal Feed</option>
                    <option value="Non-GMO Products">Non-GMO Products</option>
                    <option value="EU Organic">EU Organic Certification</option>
                    <option value="GLOBALGAP">GLOBALGAP Certification</option>
