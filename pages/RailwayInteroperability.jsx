...
const services = [
  {
    ...
    title: 'Railway Certification & Compliance',
    description: 'Complete railway interoperability certification for systems, subsystems, and components under TSI requirements.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Comprehensive evaluation of railway components against Technical Specifications for Interoperability (TSI).'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert guidance on European railway standards, EN 15085 welding certification, and TSI compliance.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Continuous surveillance and monitoring to maintain railway interoperability certification compliance.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Technical file preparation, EC declarations, and compliance documentation for railway systems.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Corrective actions for non-conformities in railway component manufacturing and quality systems.'
  }
]

const benefits = [
  { title: 'Regulatory Compliance', desc: 'Meet all EU railway interoperability directive requirements and TSI standards.' },
  { title: 'Market Access', desc: 'Access to European railway markets with certified systems and components.' },
  { title: 'Quality Assurance', desc: 'Demonstrate commitment to railway safety and interoperability standards.' },
  { title: 'Competitive Advantage', desc: 'Stand out as a certified supplier in the railway industry.' },
  { title: 'Risk Management', desc: 'Reduce liability risks through proper certification and documentation.' }
]
...
export default function RailwayInteroperability() {
  const [formData, setFormData] = useState({
    name: '',
    email: '',
    mobile: '',
    service: 'Railway Interoperability',
    message: ''
  })
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'Railway Interoperability', message: '' })
  }
    ...
    <div className="font-sans antialiased selection:bg-accent selection:text-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        <div className="absolute inset-0 z-0">
          <img 
            src="/railway-interoperability.png" 
            className="w-full h-full object-cover opacity-20 scale-105" 
            alt="Railway Interoperability"
          />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">European Railway Standards Compliance</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            Railway <br/><span className="text-accent">Interoperability</span>
          </h1>
          <p className="text-sm md:text-xl text-gray-500 font-tech font-bold uppercase tracking-[0.3em]">
            TSI Compliance & EN 15085 Certification
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-gray-800 leading-tight uppercase tracking-tighter">
                Railway <br/><span className="text-accent">Interoperability Certification</span>
              </h2>
            </div>
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              We provide comprehensive Railway certification and compliance services to help your organization meet regulatory requirements and industry standards.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is Railway Interoperability?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                Railway Interoperability certification ensures that railway systems, subsystems, and components meet European standards for safe and efficient cross-border railway operations. This includes compliance with Technical Specifications for Interoperability (TSI), EN 15085 welding certification, and other railway-specific requirements.
              </p>
            </div>
          </div>
          <div className="relative rounded-[2rem] overflow-hidden shadow-lg border border-gray-200 h-[400px] sm:h-[500px]">
            <img 
              ...
              alt="Railway Interoperability Certification"
            />
      ...
      <section className="py-16 md:py-24 relative z-10 bg-navy-light/20 border-y border-gray-100">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            ...
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Our Railway Services</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand Railway requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Initiate your Railway compliance transmission. Our industrial nodes are active and ready.
                </p>
