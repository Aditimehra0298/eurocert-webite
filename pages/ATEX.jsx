...
const services = [
  {
    ...
    title: 'ATEX Certification & Compliance',
    description: 'Complete certification services for equipment and protective systems under ATEX Directive 2014/34/EU.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Comprehensive explosive atmosphere risk assessment and equipment evaluation for hazardous locations.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert guidance on ATEX requirements, zone classification, and explosion protection methods.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Continuous surveillance and periodic inspections to maintain ATEX certification compliance.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Technical file preparation, EC declarations, and explosion protection documentation.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Corrective actions for non-conformities in explosion-proof equipment design and manufacturing.'
  }
]

const benefits = [
  { title: 'Regulatory Compliance', desc: 'Meet all EU ATEX Directive 2014/34/EU requirements for explosive atmospheres.' },
  { title: 'Market Access', desc: 'Access to European markets with ATEX-certified equipment and protective systems.' },
  { title: 'Quality Assurance', desc: 'Demonstrate commitment to safety in potentially explosive environments.' },
  { title: 'Competitive Advantage', desc: 'Stand out as a certified manufacturer of explosion-proof equipment.' },
...
export default function ATEX() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'ATEX Certification', message: '' })
  }
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Equipment for Explosive Atmospheres</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            ATEX <br/><span className="text-accent">Certification</span>
          </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              We provide comprehensive ATEX certification and compliance services to help your organization meet regulatory requirements and industry standards.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is ATEX?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                ATEX (Atmosphères Explosibles) Directive 2014/34/EU is required for equipment and protective systems intended for use in potentially explosive atmospheres. This includes equipment used in industries such as oil and gas, mining, chemical processing, and food production where flammable gases, vapors, mists, or combustible dusts may be present.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 relative z-10 bg-navy-light/20 border-y border-gray-100">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            ...
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Our ATEX Services</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand ATEX requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Initiate your ATEX compliance transmission. Our industrial nodes are active and ready.
                </p>
            ...
            <div className="lg:w-7/12 bg-white p-10 sm:p-16 relative">
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    <option value="ATEX Certification">ATEX Certification</option>
