...
const services = [
  {
    ...
    title: 'EN 15224 Certification & Compliance',
    description: 'Full scope verification and certification for Healthcare Quality Management System requirements under EN 15224.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Thorough on-site and documentation audits to evaluate your healthcare quality management system effectiveness.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Expert coaching and training for your teams on EN 15224 implementation and healthcare quality best practices.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Continuous monitoring and support to maintain your EN 15224 certification and healthcare quality standards.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Professional healthcare quality documentation, clinical risk assessments, and compliance reporting assistance.'
  },
  {
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Fixing non-conformities and gaps identified during the healthcare quality management assessment process.'
  }
]

const benefits = [
  { title: 'Regulatory Compliance', desc: 'Meet all regulatory requirements for healthcare quality management and patient safety.' },
  { title: 'Market Access', desc: 'Access markets requiring EN 15224 certification worldwide.' },
  { title: 'Quality Assurance', desc: 'Demonstrate commitment to delivering high-quality healthcare services.' },
  { title: 'Competitive Advantage', desc: 'Stand out in the healthcare industry with recognized quality management certification.' },
  { title: 'Risk Management', desc: 'Reduce clinical risks and improve patient outcomes through systematic quality management.' }
]

const relatedServices = [
  { title: 'ISO 9001', subtitle: 'Quality Management', image: '/m2.png', link: '/management-system/iso-9001' },
  { title: 'ISO 14001', subtitle: 'Environmental Management', image: '/m3.png', link: '/management-system' },
...
export default function EN15224() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', mobile: '', service: 'EN 15224', message: '' })
  }
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="EN 15224 Healthcare Quality"
          />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="inline-block glass-panel px-6 py-2 rounded-full mb-8 border-accent/30">
            <span className="text-[9px] font-tech font-bold text-accent uppercase tracking-[0.5em]">Healthcare quality management</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 tracking-wide mb-4 leading-none uppercase hero-text-shadow">
            EN 15224 <br/><span className="text-accent">Healthcare Quality</span>
          </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans max-w-xl">
              We provide comprehensive EN 15224 certification and compliance services to help your organization meet regulatory requirements and industry standards.
            </p>
            <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border-l-4 border-accent">
              <h4 className="text-gray-800 font-display font-bold uppercase tracking-widest text-lg mb-4">What is EN 15224?</h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                EN 15224 is an important standard/certification that helps organizations demonstrate compliance with regulatory requirements and industry best practices. It provides a quality management system framework specifically designed for healthcare services, focusing on clinical risk management and patient safety.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-gray-800 uppercase tracking-widest leading-none">
              Our EN 15224 <span className="text-accent">Services</span>
            </h2>
            <p className="text-gray-500 mt-6 font-tech uppercase tracking-[0.3em]">Comprehensive Healthcare Quality Solutions</p>
          </div>
      ...
      <section className="py-16 md:py-24 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="space-y-12">
            <h3 className="text-3xl font-display font-black text-gray-800 uppercase tracking-widest border-l-4 border-accent pl-6">Benefits of EN 15224</h3>
          ...
          <div className="glass-panel p-10 sm:p-12 rounded-[3rem] border border-accent/20 flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-gray-500 text-lg leading-relaxed font-sans mb-10">
              Our experienced auditors understand EN 15224 requirements and can guide you through the certification process. We work with you to ensure successful certification and ongoing compliance.
            </p>
            <div className="space-y-4">
            ...
            <div className="lg:w-5/12 bg-accent p-10 sm:p-16 flex flex-col justify-between" style={{ backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}>
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-10 max-w-sm">
                  Initiate your EN 15224 certification journey. Our healthcare quality experts are ready to assist you.
                </p>
            ...
            <div className="lg:w-7/12 bg-white p-10 sm:p-16 relative">
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    <option value="EN 15224">EN 15224 - Healthcare Quality</option>
                    ...
                    <option value="Other">Other Management System</option>
                  </select>
                </div>
                <textarea 
                  name="message"
